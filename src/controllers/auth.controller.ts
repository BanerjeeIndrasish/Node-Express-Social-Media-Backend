...
class AuthController {
    ...
    async signup(req: Request, res: Response) {
        try {
            ...
            const sendEmail = await fireotpService.sendOTP(result.user.email, 'Welcome to MyApp', `<h1>Welcome to MyApp</h1><p style={{ padding: 10, backgroundColor: 'red' }}>Your account has been created successfully.</p>`);
